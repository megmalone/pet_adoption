...
# Remove instances where the outcome date preceeds the intake date, assuming data entry issue as grabbed earliest instances:
joined_dogs <- joined_dogs %>%
...
# Deprecated code since reapproach to joining duplicates:
